        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                @can('create exciting mission')
                    <a href="{{ url('product/create') }}" class="btn btn-primary float-end">Add Misi Seru</a>
                @endcan
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered" id="product-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th>Produk Berbahaya</th>
                                <th>Tanggal Kadaluarsa</th>
                                <th>Kondisi Produk</th>
                                <th>Pre-Order</th>
                                <th>Lama Pre-Order</th>
        ...
        $(document).ready(function() {
            var table = $('#product-table').DataTable({
                ...
                columns: [{
                        ...
                        render: function(data, type, row) {
                            ...
                            if (images.length > 0) {
                                images.forEach(function(image) {
                                    var fileUrl = "{{ asset('images/products') }}/" + image
                    ...
                    {
                        data: 'product_condision',
                        name: 'product_condision'
                    },
                    {
                        data: 'pre_order',
                        name: 'pre_order'
            ...
            // Verify button click
            $('#product-table').on('click', '.verify-btn', function() {
                var id = $(this).data('id');
                Swal.fire({
                    title: 'Konfirmasi',
                    text: "Apakah Anda yakin ingin memverifikasi produk ini?",
                    icon: 'warning',
