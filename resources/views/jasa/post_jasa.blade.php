                    ...
                    @if ($service->images->isNotEmpty())
                        @foreach ($service->images as $key => $image)
                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                <img src="{{ asset('storage/service_images/' . $image->image) }}" class="d-block w-100" alt="Product Image">
                            </div>
                        @endforeach
                    @else
            ...
            <div class="product-details">
                ...
                <div class="product-description">
                    ...
                    <p class="short-description" style="color: #A9A9A9; font-weight: 300; margin: 0;">
                        {!! nl2br(e(\Str::limit($service->service_description, 300))) !!}
                        @if(strlen($service->detail_product) > 300)
