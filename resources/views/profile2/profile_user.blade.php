    ...
    <body>
        <div class="mobile-container">
                ...
                <div class="profile-background">
                    ...
                    <div class="profile-name">
                        <div class="titik-tiga">
                            <a href="{{ route('informasi_akun') }}" id="titiktiga-link"><img
                                    src="{{ asset('asset/images/profile/titiktiga.png') }} "
                                    class="check-icon-titiktiga"></a>
                        </div>
                        <div class="name">
                            <h3>Jeni lutfi fauzi</h3>
            ...
            {{-- <div class="follchat-buttons">
                ...
                <a href="{{ route('chat') }}" class="footer-link"><button class="chat-nav"
                        onclick="setActive(this, 'chat')">Pesan</button></a>
            </div> --}}
            <nav class="navbar" id="nav-id">
                <button class="nav-item" id="portofolio-nav" onclick="setActiveNav(this, 'portofolio')">Portofolio</button>
                <button class="nav-item" id="produkJasa-nav" onclick="setActiveNav(this, 'produkJasa-content')">Produk &
                    Jasa</button>
            ...
            <div id="portofolio-content" class="portofolio-image content-section" style="display: none;">
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images1.jpg') }}"
                        alt="This Image"></a>
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images2.jpg') }}"
                        alt="This Image"></a>
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images3.jpg') }}"
                        alt="This Image"></a>
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images4.jpg') }}"
                        alt="This Image"></a>
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images5.jpg') }}"
                        alt="This Image"></a>
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images6.jpg') }}"
                        alt="This Image"></a>
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images7.jpg') }}"
                        alt="This Image"></a>
                <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/images8.jpg') }}"
                        alt="This Image"></a>
            </div>
            <!-- PRODUK & JASA -->
            <div id="produkJasa-content" class="produkJasa-page content-section" style="display: none;">
                ...
                <div class="produkJasa-content-body-terlaris">
                    <div class="produkJasa-terlaris">
                        <a href="{{ route('post') }}"><img
                                src="{{ asset('asset/images/profile/jasaanimasiwebsite.png') }}" class="produkTerlaris"
                                alt="Java & Pemrograman Web"></a>
                    ...
                    <div class="produkJasa-terlaris">
                        <a href="{{ route('post') }}"><img
                                src="{{ asset('asset/images/profile/jasapembuatanmobileapp.png') }}" class="produkTerlaris"
                                alt="Produk & Website"></a>
                    ...
                    <div class="produkJasa-terlaris">
                        <a href="{{ route('post') }}"><img
                                src="{{ asset('asset/images/profile/jasapembuatansistemecomerce.png') }}"
                                class="produkTerlaris" alt="Kursus Online"></a>
                ...
                <div class="produkJasa-content-body-rekomendasi">
                    <div class="produkJasa-rekomendasi">
                        <a href="{{ route('post') }}"><img
                                src="{{ asset('asset/images/profile/jasaanimasiwebsite.png') }}"
                                class="produkRekomendasi" alt="Java & Pemrograman Web"></a>
                        <p class="jasaProdukAnimasi">Jasa animasi website interaktif javascript</p>
                        <p class="hargaProdukAnimasi">Rp20.000</p>
                    ...
                    <div class="produkJasa-rekomendasi">
                        <a href="{{ route('post') }}"><img
                                src="{{ asset('asset/images/profile/jasapembuatanmobileapp.png') }}"
                                class="produkRekomendasi" alt="Produk & Website"></a>
                        <p class="jasaMobileApp">Jasa pembuatan mobile app responsive</p>
                        <p class="hargaMobileApp">Rp20.000</p>
                        <p class="starsRekomendasi">⭐ 4.5 (120)</p>
                    </div>
                    <div class="produkJasa-rekomendasi">
                        <a href="{{ route('post') }}"><img
                                src="{{ asset('asset/images/profile/jasapembuatansistemecomerce.png') }}"
                                class="produkRekomendasi" alt="Kursus Online"></a>
                        <p class="jasaSistemEComerce">Jasa pembuatan sistem e-comerce</p>
                        <p class="hargaSistemEComerce">Rp20.000</p>
                        <p class="starsRekomendasi">⭐ 4.5 (120)</p>
                    </div>
                    <div class="produkJasa-rekomendasi">
                        <a href="{{ route('post') }}"><img src="{{ asset('asset/images/profile/jasacyber.png') }}"
                                class="produkRekomendasi" alt="Jasa Pembuatan Website"></a>
            ...
            <div id="sertifikat-content" class="sertifikat-container content-section" style="display: none;">
                ...
                <div class="sertifikat-item" data-popup-content="sertifikat-dicoding">
                    <img src="{{ asset('asset/images/profile/dicoding.png') }}" class="dicoding"
                        alt="Sertifikat Image 2">
            ...
            <div class="popup-sertifikat" id="sertifikat-google" style="display: none;">
                ...
                <div class="data-popup-content">
                    ...
                    <p class="deskripsi">Google developer course adalah pelatihan yang diadakan oleh perusahaan Google
                        untuk menciptakan developer terbaik dari seluruh dunia.</p>
            ...
            <div class="popup-pengalaman" id="myPopup">
                ...
                <div class="content-infoLainnya">
                    ...
                    <div class="social-media">
                        <a href="https://www.instagram.com"><img src="{{ asset('asset/images/profile/Instagram.png') }}"
                                alt="This Image"></a>
                        <a href="https://www.tiktok.com"><img src="{{ asset('asset/images/profile/Tiktok.png') }}"
                                alt="This Image"></a>
                        <a href="https://www.twitter.com"><img src="{{ asset('asset/images/profile/Twiter.png') }}"
                                alt="This Image"></a>
                        <a href="https://id.linkedin.com/Jenlutfauzi"><img
                                src="{{ asset('asset/images/profile/LinkedIn.png') }}" alt="This Image"></a>
                        <a href="https://www.google.com"><img src="{{ asset('asset/images/profile/Internet.png') }}"
                                alt="This Image"></a>
                    </div>
                    <p class="kerjaSeller">Pengalaman kerja seller</p>
                    <div class="pengalaman-kerja">
                        <img src="{{ asset('asset/images/profile/google.png') }}" class="androidDev"
                            alt="Sertifikat Image 1">
