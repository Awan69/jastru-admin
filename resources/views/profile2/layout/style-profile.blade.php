...
@push('style-profile')
  <style>
        ...
        .profile-aboutme {
            /*padding: 10px;*/
            margin-top: 50px;
            margin-bottom: 20px; /* Tambahkan margin bawah untuk memberi jarak dengan navbar */
            padding: 20px; /* Tambahkan padding jika diperlukan */
            background-color: #fff; /* Pastikan latar belakang agar terlihat jelas */
        ...
        .loading {
            ...
            border-radius: 50%;
            animation: spin s linear infinite; /* Percepat animasi loading */
            margin-right: 5px;
            position: absolute;
            top: 15px;
            left: 115px;
        ...
        /* Tambahkan CSS untuk button ikuti */
        #ikutiButton {
